...
namespace Veracity.ApiClients.MyServices.MyServicesV3Api
{
    ...
    public static partial class ThisModelExtensions
    {
            ...
            /// Veracity api management subscription key
            /// </param>
            public static ThisRemoveServiceUserHeaders RemoveServiceUser(this IThisModel operations, string userId, string serviceId, string xSupportCode = default(string), string ocpApimSubscriptionKey = default(string))
            {
                return operations.RemoveServiceUserAsync(userId, serviceId, xSupportCode, ocpApimSubscriptionKey).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ThisRemoveServiceUserHeaders> RemoveServiceUserAsync(this IThisModel operations, string userId, string serviceId, string xSupportCode = default(string), string ocpApimSubscriptionKey = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.RemoveServiceUserWithHttpMessagesAsync(userId, serviceId, xSupportCode, ocpApimSubscriptionKey, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Headers;
                }
            }
