...
namespace Veracity.ApiClients.MyServices.MyServicesV3Api.Models
{
    ...
    /// <summary>
    /// Defines headers for GetMyWidgets operation.
    /// </summary>
    public partial class MyGetMyWidgetsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the MyGetMyWidgetsHeaders class.
        /// </summary>
        public MyGetMyWidgetsHeaders()
        {
            CustomInit();
        }
        ...
        /// lookup.</param>
        public MyGetMyWidgetsHeaders(string xSupportCode = default(string))
        {
