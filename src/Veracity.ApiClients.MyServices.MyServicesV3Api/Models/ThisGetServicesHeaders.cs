...
namespace Veracity.ApiClients.MyServices.MyServicesV3Api.Models
{
    ...
    /// <summary>
    /// Defines headers for GetServices operation.
    /// </summary>
    public partial class ThisGetServicesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ThisGetServicesHeaders class.
        /// </summary>
        public ThisGetServicesHeaders()
        {
            CustomInit();
        }
        ...
        /// lookup.</param>
        public ThisGetServicesHeaders(string xSupportCode = default(string))
        {
