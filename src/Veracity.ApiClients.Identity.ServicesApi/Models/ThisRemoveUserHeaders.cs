...
namespace Veracity.ApiClients.Identity.ServicesApi.Models
{
    ...
    /// <summary>
    /// Defines headers for RemoveUser operation.
    /// </summary>
    public partial class ThisRemoveUserHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ThisRemoveUserHeaders class.
        /// </summary>
        public ThisRemoveUserHeaders()
        {
            CustomInit();
        }
        ...
        /// lookup.</param>
        public ThisRemoveUserHeaders(string xSupportCode = default(string))
        {
