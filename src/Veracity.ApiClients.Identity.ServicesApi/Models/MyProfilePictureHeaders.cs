...
namespace Veracity.ApiClients.Identity.ServicesApi.Models
{
    ...
    /// <summary>
    /// Defines headers for ProfilePicture operation.
    /// </summary>
    public partial class MyProfilePictureHeaders
    {
        /// <summary>
        /// Initializes a new instance of the MyProfilePictureHeaders class.
        /// </summary>
        public MyProfilePictureHeaders()
        {
            CustomInit();
        }
        ...
        /// lookup.</param>
        public MyProfilePictureHeaders(string xSupportCode = default(string))
        {
