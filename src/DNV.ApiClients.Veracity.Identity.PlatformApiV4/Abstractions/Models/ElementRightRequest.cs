...
namespace DNV.ApiClients.Veracity.Identity.PlatformApiV4.Models
{
    ...
    public partial class ElementRightRequest
    {
        ...
        /// <param name="isAdmin">Grant the users to manage licenses for this
        /// application/element. Only used for V1 access levels in the Veracity
        /// platform. This will be removed as the legacy applications upgrades
        /// to the new model.</param>
