...
namespace DNV.ApiClients.Veracity.Identity.PlatformApiV4.Models
{
    ...
    /// paged query.
    /// </summary>
    public partial class PagedElementResponse
    {
        /// <summary>
        /// Initializes a new instance of the PagedElementResponse class.
        /// </summary>
        public PagedElementResponse()
        {
            CustomInit();
        }
        ...
        public PagedElementResponse(IEnumerable<ElementResponse> items = default, int? pageCount = default, long? totalCount = default, string nextPageUrl = default)
        {
            Items = items;
            PageCount = pageCount;
        ...
        public IEnumerable<ElementResponse> Items { get; set; }
