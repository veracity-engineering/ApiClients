...
namespace DNV.ApiClients.Veracity.Identity.ServicesApi.Models
{
    ...
    /// <summary>
    /// Defines headers for ResolveUser operation.
    /// </summary>
    public partial class ThisResolveUserHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ThisResolveUserHeaders class.
        /// </summary>
        public ThisResolveUserHeaders()
        {
            CustomInit();
        }
        ...
        /// lookup.</param>
        public ThisResolveUserHeaders(string xSupportCode = default(string))
        {
