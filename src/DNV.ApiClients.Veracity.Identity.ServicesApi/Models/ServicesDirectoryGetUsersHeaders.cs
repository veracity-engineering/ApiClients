...
namespace DNV.ApiClients.Veracity.Identity.ServicesApi.Models
{
    ...
    /// </summary>
    public partial class ServicesDirectoryGetUsersHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ServicesDirectoryGetUsersHeaders
        /// class.
        /// </summary>
        public ServicesDirectoryGetUsersHeaders()
        {
            CustomInit();
        }
        ...
        /// lookup.</param>
        public ServicesDirectoryGetUsersHeaders(string xSupportCode = default(string))
        {
