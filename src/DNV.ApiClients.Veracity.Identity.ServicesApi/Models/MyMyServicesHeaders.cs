...
namespace DNV.ApiClients.Veracity.Identity.ServicesApi.Models
{
    ...
    /// <summary>
    /// Defines headers for MyServices operation.
    /// </summary>
    public partial class MyMyServicesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the MyMyServicesHeaders class.
        /// </summary>
        public MyMyServicesHeaders()
        {
            CustomInit();
        }
        ...
        /// lookup.</param>
        public MyMyServicesHeaders(string xSupportCode = default(string))
        {
