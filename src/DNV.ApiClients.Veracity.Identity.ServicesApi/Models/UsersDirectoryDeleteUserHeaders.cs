...
namespace DNV.ApiClients.Veracity.Identity.ServicesApi.Models
{
    ...
    /// </summary>
    public partial class UsersDirectoryDeleteUserHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UsersDirectoryDeleteUserHeaders
        /// class.
        /// </summary>
        public UsersDirectoryDeleteUserHeaders()
        {
            CustomInit();
        }
        ...
        /// lookup.</param>
        public UsersDirectoryDeleteUserHeaders(string xSupportCode = default(string))
        {
