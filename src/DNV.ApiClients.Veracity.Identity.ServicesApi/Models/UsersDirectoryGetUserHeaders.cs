...
namespace DNV.ApiClients.Veracity.Identity.ServicesApi.Models
{
    ...
    /// <summary>
    /// Defines headers for GetUser operation.
    /// </summary>
    public partial class UsersDirectoryGetUserHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UsersDirectoryGetUserHeaders
        /// class.
        /// </summary>
        public UsersDirectoryGetUserHeaders()
        {
            CustomInit();
        }
        ...
        /// lookup.</param>
        public UsersDirectoryGetUserHeaders(string xSupportCode = default(string))
        {
