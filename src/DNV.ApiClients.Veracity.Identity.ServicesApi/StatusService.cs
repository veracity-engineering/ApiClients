...
namespace DNV.ApiClients.Veracity.Identity.ServicesApi
{
    ...
    /// </summary>
    public partial class StatusService : IServiceOperations<ServicesApiClient>, IStatusService
    {
        /// <summary>
        ...
        /// </exception>
        public StatusService(ServicesApiClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<HealthStatus,StatusServiceGetServiceHealthStatusHeaders>> GetServiceHealthStatusWithHttpMessagesAsync(string xSupportCode = default, string ocpApimSubscriptionKey = default, Dictionary<string, IList<string>> customHeaders = null, CancellationToken cancellationToken = default)
        {
            // Tracing
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "GetServiceHealthStatus", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.HttpClient.BaseAddress?.AbsoluteUri ?? Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "health/status").ToString();
            ...
            // Create Result
            var _result = new HttpOperationResponse<HealthStatus,StatusServiceGetServiceHealthStatusHeaders>();
            ...
            try
            {
                _result.Headers = _httpResponse.GetHeadersAsJson().ToObject<StatusServiceGetServiceHealthStatusHeaders>(JsonSerializer.Create(Client.DeserializationSettings));
            }
            catch (JsonException ex)
            {
                _httpRequest.Dispose();
