...
namespace DNV.ApiClients.Veracity.Identity.ServicesApi.Interfaces
{
    ...
    public partial interface IServicesDirectory
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<ServiceInfo,ServicesDirectoryGetServiceByIdHeaders>> GetServiceByIdWithHttpMessagesAsync(string id, string xSupportCode = default, string ocpApimSubscriptionKey = default, Dictionary<string, IList<string>> customHeaders = null, CancellationToken cancellationToken = default);
        /// <summary>
