...
namespace DNV.ApiClients.Veracity.Identity.InternalPlatformApiV4.Models
{
    ...
    /// paged query.
    /// </summary>
    public partial class PagedTenantResponse
    {
        /// <summary>
        /// Initializes a new instance of the PagedTenantResponse class.
        /// </summary>
        public PagedTenantResponse()
        {
            CustomInit();
        }
        ...
        public PagedTenantResponse(IEnumerable<TenantResponse> items = default, int? pageCount = default, long? totalCount = default, string nextPageUrl = default)
        {
            Items = items;
            PageCount = pageCount;
        ...
        public IEnumerable<TenantResponse> Items { get; set; }
