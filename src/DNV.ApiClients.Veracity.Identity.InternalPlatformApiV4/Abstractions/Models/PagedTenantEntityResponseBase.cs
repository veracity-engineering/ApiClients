...
namespace DNV.ApiClients.Veracity.Identity.InternalPlatformApiV4.Models
{
    ...
    /// paged query.
    /// </summary>
    public partial class PagedTenantEntityResponseBase
    {
        /// <summary>
        /// Initializes a new instance of the PagedTenantEntityResponseBase
        /// class.
        /// </summary>
        public PagedTenantEntityResponseBase()
        {
            CustomInit();
        }
        ...
        public PagedTenantEntityResponseBase(IEnumerable<TenantEntityResponseBase> items = default, int? pageCount = default, long? totalCount = default, string nextPageUrl = default)
        {
            Items = items;
            PageCount = pageCount;
        ...
        public IEnumerable<TenantEntityResponseBase> Items { get; set; }
