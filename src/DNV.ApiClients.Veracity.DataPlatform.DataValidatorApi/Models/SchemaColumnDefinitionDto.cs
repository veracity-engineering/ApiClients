...
namespace DNV.ApiClients.Veracity.DataPlatform.DataValidatorApi.Models
{
    ...
    public partial class SchemaColumnDefinitionDto
    {
        ...
        public SchemaColumnDefinitionDto(string name = default(string), bool? mustBePresent = default(bool?), string metaFormat = default(string), IDictionary<string, Severity?> rules = default(IDictionary<string, Severity?>), MetaType? metaType = default(MetaType?))
        {
            Name = name;
