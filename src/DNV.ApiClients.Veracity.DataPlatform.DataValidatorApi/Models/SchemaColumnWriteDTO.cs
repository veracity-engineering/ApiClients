...
namespace DNV.ApiClients.Veracity.DataPlatform.DataValidatorApi.Models
{
    ...
    public partial class SchemaColumnWriteDTO
    {
        ...
        public SchemaColumnWriteDTO(string name = default, bool? mustBePresent = default, int? columnOrder = default, string metaFormat = default, IEnumerable<ColumnValidatorColumnWriteDTO> columnValidators = default, SchemaColumnType? schemaColumnType = default, MetaType? metaType = default)
        {
            Name = name;
        ...
        public IEnumerable<ColumnValidatorColumnWriteDTO> ColumnValidators { get; set; }
