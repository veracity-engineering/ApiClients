...
namespace DNV.ApiClients.Veracity.DataPlatform.DataValidatorApi.Models
{
    ...
    public partial class SchemaColumnReadDTO
    {
        ...
        public SchemaColumnReadDTO(int? schemaColumnId = default, string name = default, System.Guid? schemaVersionId = default, bool? mustBePresent = default, int? columnOrder = default, string metaFormat = default, IEnumerable<ColumnValidatorColumnReadDTO> columnValidators = default, SchemaColumnType? schemaColumnType = default, MetaType? metaType = default)
        {
        ...
        public IEnumerable<ColumnValidatorColumnReadDTO> ColumnValidators { get; set; }
