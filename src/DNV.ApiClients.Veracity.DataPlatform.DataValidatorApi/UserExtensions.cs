...
namespace DNV.ApiClients.Veracity.DataPlatform.DataValidatorApi
{
    ...
    public static partial class UserExtensions
    {
            ...
            /// Format - uuid.
            /// </param>
            public static IEnumerable<WorkspaceUserReadDTO> GetUserList(this IUser operations, string id)
            {
            ...
            /// </param>
            public static async Task<IEnumerable<WorkspaceUserReadDTO>> GetUserListAsync(this IUser operations, string id, CancellationToken cancellationToken = default)
            {
