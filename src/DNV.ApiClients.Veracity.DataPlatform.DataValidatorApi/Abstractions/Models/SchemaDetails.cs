...
namespace DNV.ApiClients.Veracity.DataPlatform.DataValidatorApi.Models
{
    ...
    public partial class SchemaDetails
    {
        ...
        /// Initializes a new instance of the SchemaDetails class.
        /// </summary>
        public SchemaDetails(System.Guid? schemaId = default, string name = default, string shortName = default, string description = default, bool? isPredefined = default, System.Guid? workspaceId = default, SchemaVersionReadDTO activeVersion = default, IEnumerable<SchemaVersionReadDTO> versions = default)
        {
            SchemaId = schemaId;
            Name = name;
            ShortName = shortName;
        ...
        public IEnumerable<SchemaVersionReadDTO> Versions { get; set; }
