...
namespace DNV.ApiClients.Veracity.Identity.ServicesApi.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the CompanyReference class.
        /// </summary>
        ...
        /// details</param>
        public CompanyReference(string identity = default(string), string name = default(string), string id = default(string), string description = default(string))
        {
            Identity = identity;
            Name = name;
            Id = id;
