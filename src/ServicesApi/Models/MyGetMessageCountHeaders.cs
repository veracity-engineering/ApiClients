...
namespace DNV.ApiClients.Veracity.Identity.ServicesApi.Models
{
    ...
    /// <summary>
    /// Defines headers for GetMessageCount operation.
    /// </summary>
    public partial class MyGetMessageCountHeaders
    {
        /// <summary>
        /// Initializes a new instance of the MyGetMessageCountHeaders class.
        /// </summary>
        public MyGetMessageCountHeaders()
        {
            CustomInit();
        }
        ...
        /// lookup.</param>
        public MyGetMessageCountHeaders(string xSupportCode = default(string))
        {
