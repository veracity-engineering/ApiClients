...
namespace DNV.ApiClients.Veracity.DataPlatform.DataApi
{
    ...
    /// <summary>
    /// Extension methods for V10Access.
    /// </summary>
    public static partial class V10AccessExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static PagedResultProviderAccessVM Get(this IV10Access operations, string resourceId, int? pageNo = default, int? pageSize = default)
            {
            ...
            /// </param>
            public static async Task<PagedResultProviderAccessVM> GetAsync(this IV10Access operations, string resourceId, int? pageNo = default, int? pageSize = default, CancellationToken cancellationToken = default)
            {
            ...
            /// <param name='body'>
            /// </param>
            public static ShareResourceVM Post(this IV10Access operations, string resourceId, bool autoRefreshed, SharingResourceInputData body = default)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ShareResourceVM> PostAsync(this IV10Access operations, string resourceId, bool autoRefreshed, SharingResourceInputData body = default, CancellationToken cancellationToken = default)
            {
            ...
            /// </param>
            public static void Put(this IV10Access operations, string resourceId, string accessId)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task PutAsync(this IV10Access operations, string resourceId, string accessId, CancellationToken cancellationToken = default)
            {
            ...
            /// Format - uuid. Access Id
            /// </param>
            public static SASToken ClaimKey(this IV10Access operations, string resourceId, string accessId)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<SASToken> ClaimKeyAsync(this IV10Access operations, string resourceId, string accessId, CancellationToken cancellationToken = default)
            {
