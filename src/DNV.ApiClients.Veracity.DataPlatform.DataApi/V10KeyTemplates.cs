...
namespace DNV.ApiClients.Veracity.DataPlatform.DataApi
{
    ...
    public partial class V10KeyTemplates : IServiceOperations<DataApiClient>, IV10KeyTemplates
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<IEnumerable<KeyTemplateVM>>> GetStorageKeyTemplatesWithHttpMessagesAsync(Dictionary<string, IList<string>> customHeaders = null, CancellationToken cancellationToken = default)
        {
            // Tracing
