...
namespace DNV.ApiClients.Veracity.DataPlatform.DataApi
{
    ...
    /// <summary>
    /// Extension methods for KeyTemplates.
    /// </summary>
    public static partial class KeyTemplatesExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static IList<KeyTemplateVM> GetStorageKeyTemplates(this IKeyTemplates operations)
            {
            ...
            /// </param>
            public static async Task<IList<KeyTemplateVM>> GetStorageKeyTemplatesAsync(this IKeyTemplates operations, CancellationToken cancellationToken = default(CancellationToken))
            {
