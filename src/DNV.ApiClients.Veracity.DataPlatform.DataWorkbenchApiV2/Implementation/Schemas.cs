...
namespace DNV.ApiClients.Veracity.DataPlatform.DataWorkbenchApiV2
{
    ...
    public partial class Schemas : IServiceOperations<DataWorkbenchApiV2Client>, ISchemas
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<IEnumerable<SchemaVersionReadDto>>> AddSchemaWithHttpMessagesAsync(SchemaWriteDto body, System.Guid workspaceId, Dictionary<string, IList<string>> customHeaders = null, CancellationToken cancellationToken = default)
        {
            if (body == null)
            {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<IEnumerable<SchemaVersionReadDto>> AddSchemaAsync(SchemaWriteDto body, System.Guid workspaceId, CancellationToken cancellationToken = default)
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<SchemaVersionReadDto>> MakeSchemaVersionDefaultWithHttpMessagesAsync(System.Guid workspaceId, System.Guid schemaId, System.Guid schemaVersionId, Dictionary<string, IList<string>> customHeaders = null, CancellationToken cancellationToken = default)
        {
            // Construct URL
            var _baseUrl = Client.HttpClient.BaseAddress?.AbsoluteUri ?? Client.BaseUri.AbsoluteUri;
        ...
        /// The cancellation token.
        /// </param>
        public async Task<SchemaVersionReadDto> MakeSchemaVersionDefaultAsync(System.Guid workspaceId, System.Guid schemaId, System.Guid schemaVersionId, CancellationToken cancellationToken = default)
        {
            using (var _result = await MakeSchemaVersionDefaultWithHttpMessagesAsync(workspaceId, schemaId, schemaVersionId, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
            }
        }
