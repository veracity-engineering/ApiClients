...
namespace DNV.ApiClients.Veracity.Identity.ServicesApiV3.Models
{
    ...
    public partial class UserInfo
    {
        ...
        public UserInfo(int companies, bool verifiedEmail, bool verifiedPhone, bool managedAccount, bool activated, bool accessHubEnabled, string name = default, string email = default, string id = default, string language = default, string identity = default, string phone = default, string servicesUrl = default, string companiesUrl = default, string firstName = default, string lastName = default, string countryCode = default)
        {
            Name = name;
            Email = email;
            Id = id;
