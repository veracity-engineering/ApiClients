...
namespace DNV.ApiClients.Veracity.Identity.ServicesApiV3.Models
{
    ...
    public partial class MyUserInfo
    {
        ...
        public MyUserInfo(int companies, bool verifiedEmail, bool verifiedPhone, bool managedAccount, bool activated, bool accessHubEnabled, string profilePageUrl = default, string messagesUrl = default, string identity = default, string servicesUrl = default, string companiesUrl = default, string name = default, string email = default, string id = default, string language = default, string phone = default, string firstName = default, string lastName = default, string countryCode = default)
        {
            ...
            Activated = activated;
            AccessHubEnabled = accessHubEnabled;
            CustomInit();
        }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "accessHubEnabled")]
        public bool AccessHubEnabled { get; set; }
