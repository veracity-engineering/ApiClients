...
namespace DNV.ApiClients.Veracity.Identity.ServicesApiV3.Models
{
    ...
    public partial class AdminReference
    {
        ...
        /// details</param>
        public AdminReference(bool activated, string accessLevelUrl = default, string serviceId = default, string identity = default, string email = default, string tenantId = default, string name = default, string id = default)
        {
