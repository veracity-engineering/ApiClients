...
namespace DNV.ApiClients.Veracity.Identity.ServicesApiV3.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the SubscriptionReference class.
        /// </summary>
        ...
        /// details</param>
        public SubscriptionReference(bool activated, string state = default, string role = default, string identity = default, string email = default, string tenantId = default, string name = default, string id = default)
        {
            State = state;
            Role = role;
            Identity = identity;
