...
namespace DNV.ApiClients.Veracity.Identity.ServicesApiV3.Models
{
    ...
    public partial class ServiceInfo
    {
        ...
        /// Initializes a new instance of the ServiceInfo class.
        /// </summary>
        public ServiceInfo(bool publicProperty, bool inherited, bool selfSubscribe, string name = default, string shortDescription = default, string description = default, string apiAudience = default, string category = default, string tenantId = default, string pricingTier = default, string id = default, string serviceOwner = default, string termsOfUse = default, System.DateTime? lastUpdated = default, string parentUrl = default, string parentId = default, string childrenUrl = default, string servicerUrl = default)
        {
            Name = name;
