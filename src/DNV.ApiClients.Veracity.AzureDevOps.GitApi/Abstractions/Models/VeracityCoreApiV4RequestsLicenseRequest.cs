...
namespace DNV.ApiClients.Veracity.AzureDevOps.GitApi.Models
{
    ...
    /// </summary>
    public partial class VeracityCoreApiV4RequestsLicenseRequest
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VeracityCoreApiV4RequestsLicenseRequest class.
        /// </summary>
        public VeracityCoreApiV4RequestsLicenseRequest()
        {
            CustomInit();
        }
        ...
        public VeracityCoreApiV4RequestsLicenseRequest(System.Guid entityId, VeracityCoreApiV4ResponsesEntityTypes licenseType, string accessLevel = default, bool? isApplicationAdmin = default, bool? canAddUsersToTenant = default, IEnumerable<VeracityCoreApiV4ResponsesExtensionProperty> properties = default)
        {
            EntityId = entityId;
