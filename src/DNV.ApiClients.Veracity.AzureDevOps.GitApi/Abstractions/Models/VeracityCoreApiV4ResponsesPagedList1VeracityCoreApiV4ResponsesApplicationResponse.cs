...
namespace DNV.ApiClients.Veracity.AzureDevOps.GitApi.Models
{
    ...
    /// paged query.
    /// </summary>
    public partial class VeracityCoreApiV4ResponsesPagedList1VeracityCoreApiV4ResponsesApplicationResponse
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VeracityCoreApiV4ResponsesPagedList1VeracityCoreApiV4ResponsesApplicationResponse
        /// class.
        /// </summary>
        public VeracityCoreApiV4ResponsesPagedList1VeracityCoreApiV4ResponsesApplicationResponse()
        {
            CustomInit();
        }
        ...
        public VeracityCoreApiV4ResponsesPagedList1VeracityCoreApiV4ResponsesApplicationResponse(IEnumerable<VeracityCoreApiV4ResponsesApplicationResponse> items = default, int? pageCount = default, long? totalCount = default, string nextPageUrl = default)
        {
            Items = items;
            PageCount = pageCount;
        ...
        public IEnumerable<VeracityCoreApiV4ResponsesApplicationResponse> Items { get; set; }
