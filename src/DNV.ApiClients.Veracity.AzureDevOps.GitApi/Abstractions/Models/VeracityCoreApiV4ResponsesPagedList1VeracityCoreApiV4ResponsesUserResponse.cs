...
namespace DNV.ApiClients.Veracity.AzureDevOps.GitApi.Models
{
    ...
    /// paged query.
    /// </summary>
    public partial class VeracityCoreApiV4ResponsesPagedList1VeracityCoreApiV4ResponsesUserResponse
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VeracityCoreApiV4ResponsesPagedList1VeracityCoreApiV4ResponsesUserResponse
        /// class.
        /// </summary>
        public VeracityCoreApiV4ResponsesPagedList1VeracityCoreApiV4ResponsesUserResponse()
        {
            CustomInit();
        }
        ...
        public VeracityCoreApiV4ResponsesPagedList1VeracityCoreApiV4ResponsesUserResponse(IEnumerable<VeracityCoreApiV4ResponsesUserResponse> items = default, int? pageCount = default, long? totalCount = default, string nextPageUrl = default)
        {
            Items = items;
            PageCount = pageCount;
        ...
        public IEnumerable<VeracityCoreApiV4ResponsesUserResponse> Items { get; set; }
