...
namespace DNV.ApiClients.Veracity.AzureDevOps.GitApi.Models
{
    ...
    /// </summary>
    public partial class VeracityCoreApiV4ResponsesErrorDetail
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VeracityCoreApiV4ResponsesErrorDetail class.
        /// </summary>
        public VeracityCoreApiV4ResponsesErrorDetail()
        {
            CustomInit();
        }
        ...
        /// error</param>
        public VeracityCoreApiV4ResponsesErrorDetail(string correlationId = default, string supportCode = default, int? subCode = default, string message = default, string information = default)
        {
