...
namespace DNV.ApiClients.Veracity.AzureDevOps.GitApi.Models
{
    ...
    /// paged query.
    /// </summary>
    public partial class VeracityCoreApiV4ResponsesPagedList1VeracityCoreApiV4ResponsesGroupResponse
    {
        /// <summary>
        /// Initializes a new instance of the
        /// VeracityCoreApiV4ResponsesPagedList1VeracityCoreApiV4ResponsesGroupResponse
        /// class.
        /// </summary>
        public VeracityCoreApiV4ResponsesPagedList1VeracityCoreApiV4ResponsesGroupResponse()
        {
            CustomInit();
        }
        ...
        public VeracityCoreApiV4ResponsesPagedList1VeracityCoreApiV4ResponsesGroupResponse(IEnumerable<VeracityCoreApiV4ResponsesGroupResponse> items = default, int? pageCount = default, long? totalCount = default, string nextPageUrl = default)
        {
            Items = items;
            PageCount = pageCount;
        ...
        public IEnumerable<VeracityCoreApiV4ResponsesGroupResponse> Items { get; set; }
