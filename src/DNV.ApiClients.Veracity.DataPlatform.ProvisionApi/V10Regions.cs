...
namespace DNV.ApiClients.Veracity.DataPlatform.ProvisionApi
{
    ...
    /// </summary>
    public partial class V10Regions : IServiceOperations<ProvisionApiClient>, IV10Regions
    {
        /// <summary>
        /// Initializes a new instance of the V10Regions class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        public V10Regions(ProvisionApiClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<IEnumerable<StorageRegion>>> GetWithHttpMessagesAsync(Dictionary<string, IList<string>> customHeaders = null, CancellationToken cancellationToken = default)
        {
            // Tracing
